...
import styles from './DipsTodosDocumentosPorStatus.module.scss';
import { IDipsTodosDocumentosPorStatusProps } from './IDipsTodosDocumentosPorStatusProps';
...
export default class DipsTodosDocumentosPorStatus extends React.Component<IDipsTodosDocumentosPorStatusProps, IShowEmployeeStates> {

  constructor(props: IDipsTodosDocumentosPorStatusProps) {
    super(props);
    this.state = {
      itemsList: []
    }
  ...
  public async componentDidMount() {
    ...
    if (statusDocumento == "Todos") var url = `${this.props.siteurl}/_api/web/lists/getbytitle('Documentos')/items?$top=4999&$orderby= ID desc&$select=ID,NomeProduto,Title,Versao,Status,Cliente,Created,Author/Title&$expand=Author`;
    else if (statusDocumento == "Aguardando aprovação do Suporte") var url = `${this.props.siteurl}/_api/web/lists/getbytitle('Documentos')/items?$top=4999&$orderby= ID desc&$select=ID,NomeProduto,Title,Versao,Status,Cliente,Created,Author/Title&$expand=Author&$filter= Status eq 'Aguardando aprovação do Suporte'`;
  ...
  public render(): React.ReactElement<IDipsTodosDocumentosPorStatusProps> {
